...
![1550831221425](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1550831221425.png)
...
![1551079444283](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1551079444283.png)
...
![img](C:\Users\lishun\Desktop\总结\风控api内存分析/1016758851.jpg) 
...
![img](C:\Users\lishun\Desktop\总结\风控api内存分析/1179787087.jpg) 

还可以在第一行的regex里填写条件，此时填写应用的包名，就可以过滤到目前应用中所有对象占用的内存大小，如下图，可以发现，没有什么问题，NameList是黑白名单的缓存信息，其他的数量都很少。

![1550890183795](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1550890183795.png)
...
![1550889506708](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1550889506708.png)
...
![1550890433755](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1550890433755.png)

除了包之外，上面三个统计都有一个饼图展示结合一个表格展示。比如展开对象的统计信息如下图所示，同Dominator Tree中统计信息相同。

![1550890459861](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1550890459861.png)
...
![1550890740961](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1550890740961.png)
...
![1550892184713](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1550892184713.png)
...
![1551062337907](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1551062337907.png)
...
![img](C:\Users\lishun\Desktop\总结\风控api内存分析/193903631.jpg) 
...
![img](C:\Users\lishun\Desktop\总结\风控api内存分析/532432054.jpg) 

4.Accumulated Objects by Class in Dominator Tree（以当前问题对象为根的Dominator支配树按类的维度分类统计）

这里其实是将上面的支配树中的对象按类汇总了一下，查看相关类占用的内存大小。

![1551064233151](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1551064233151.png)
...
![img](C:\Users\lishun\Desktop\总结\风控api内存分析/1124134022.jpg) 

## 4.2 Top Components

展示了大于1%内存的组件

![img](C:\Users\lishun\Desktop\总结\风控api内存分析/4121744767.jpg) 

没有发现跟应用相关的类，我们可以点击第一个进行查看具体的分析。

该详情页面有包含可能的内存浪费分析的，如下图显示有重复字符串分析、空集合分析及集合填充率分析等。本应用没有出现过度使用的空集合及大量低填充率的集合，但是发现有重复字符串的问题。

![1551076010286](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1551076010286.png)

可以看到问题描述为找到了119个char[]实例，其中至少有10个实例具有相同的内容，总大小为2609832bytes。什么意思呢，就是重复出现最少十次的char[]共有119个，点击Detail进行查看具体重复字符串信息。

![1551076673404](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1551076673404.png)
...
![1551076799515](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1551076799515.png)

（本节详细分析TODO）也有对象软弱引用及实现了finalize方法、map集合碰撞率等的分析。关于soft 和 weak 引用我们大致看一下就OK了，没什么问题就可以，详细的统计可以点击Detail查看。

![1551077082159](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1551077082159.png)
...
![1551078518047](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1551078518047.png)
...
![1551078769952](https://github.com/ls960972314/ls960972314.github.io/blob/master/_posts/mat-introduce/1551078769952.png)
...
![img](C:\Users\lishun\Desktop\总结\风控api内存分析/599344462.jpg) 
